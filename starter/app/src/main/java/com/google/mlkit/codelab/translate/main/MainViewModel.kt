...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // Done: Instantiate LanguageIdentification
    ...
    val sourceLang = Transformations.switchMap(sourceText) { text ->
        ...
        // DONE:  Call the language identification method and assigns the result if it is not
        //  undefined (“und”)
    ...
    override fun onCleared() {
        // DONE: Shut down ML Kit clients.
        languageIdentifier.close()
        translators.evictAll()
    }

    private fun translate(): Task<String> {
        // done Take the source language value, target language value, and the source text and
